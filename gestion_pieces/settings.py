...
SECRET_KEY = 'django-insecure-gestion-pieces-2026-secret-key-change-in-production'
...
ROOT_URLCONF = 'gestion_pieces.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pieces.context_processors.nb_critiques',
            ],
        },
    },
]

WSGI_APPLICATION = 'gestion_pieces.wsgi.application'
